package cn.org.aiit.ddex.config
...
class CacheConfiguration(
    ...
    fun cacheManagerCustomizer(): JCacheManagerCustomizer {
        return JCacheManagerCustomizer { cm ->
            createCache(cm, cn.org.aiit.ddex.repository.UserRepository.USERS_BY_LOGIN_CACHE)
            createCache(cm, cn.org.aiit.ddex.repository.UserRepository.USERS_BY_EMAIL_CACHE)
            createCache(cm, cn.org.aiit.ddex.domain.User::class.java.name)
            createCache(cm, cn.org.aiit.ddex.domain.Authority::class.java.name)
            createCache(cm, cn.org.aiit.ddex.domain.User::class.java.name + ".authorities")
